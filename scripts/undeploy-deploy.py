import sys
appname1=sys.argv[1]
apppath='/u01/app/oracle/middleware1/applications/'
def wlDeployUndeploy(username, password, adminURL, appName, location, targets, stageMode):
    try:
        ...
        #print 'Done deploying application' +appname
         ...
         print ex.toString()
wlDeployUndeploy('weblogic','weblogic1','t3://192.168.56.101:7001', appname1, apppath + appname1 + ".war", targets='Mycluster', stageMode='stage')
